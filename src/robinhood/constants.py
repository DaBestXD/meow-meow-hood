...
API_FUTURES_QUOTES = "/marketdata/futures/quotes/v1/"
API_INDEXES = "/indexes/"
...
API_OPTION_ORDER = "/options/orders/"  # Post endpoint
API_OPTION_ORDER_HISTORY = "/options/orders/"  # Get endpoint
